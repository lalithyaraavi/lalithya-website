...
export const projects: Project[] = [
  {
    ...
    description:
      "PRESENSE is a safety companion designed for moments of uncertainty. We designed an interface that is calm and supportive, but built for instant action. Using Figma's digital design and prototyping tools, every element was intentionally simplified so users can navigate without hesitation, especially when it matters most.",
  ...
  },
  {
    ...
    tagline: "Gamified chore productivity",
    tags: ["Product Design", "Prototyping", "Figma"],
    year: "2026",
    color: "#E8E2F5",
  ...
  },
  {
    ...
    tags: ["Experimental Design", "Data & Analysis", "Sustainability"],
    year: "2024",
    color: "#D6EAD6",
  ...
  },
  {
    ...
    tags: ["Quantitative Research", "Nutrition", "Experimental Analysis"],
    year: "2023",
    color: "#FDECD7",
  ...
  },
  {
    ...
    tags: ["Environmental Systems", "Data Analysis", "Materials Testing", "Sustainability"],
    year: "2025",
    color: "#D6EAD6",
